    ...
    **/
    ...
    $.fn.editable.defaults = {
        ...
        **Please note**, that delegated targets can't use `emptytext` and `autotext` options, 
        ...
        @example
        <div id="user">
          <a href="javascript:void(0)" data-name="username" data-type="text" title="Username">awesome</a>
          <a href="javascript:void(0)" data-name="group" data-type="select" data-source="/groups" data-value="1" title="Group">Operator</a>
        </div>     
...
@final
@example
<a href="javascript:void(0)" id="country" data-type="select2" data-pk="1" data-value="ru" data-url="/post" data-original-title="Select country"></a>
<script>
$(function(){
    $('#country').editable({
        source: [
