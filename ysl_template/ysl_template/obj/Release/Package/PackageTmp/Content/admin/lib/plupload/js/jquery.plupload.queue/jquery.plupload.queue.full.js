							...
							'<div class="plupload_filelist_footer">' +
								'<div class="plupload_file_name">' +
									'<div class="plupload_buttons">' +
										'<a href="javascript:void(0)" class="btn btn-mini plupload_add sepV_b"><i class="icon-plus"></i> ' + _('Add files') + '</a>' +
										'<a href="javascript:void(0)" class="btn btn-mini plupload_start"><i class="icon-upload"></i> ' + _('Start upload') + '</a>' +
									'</div>' +
