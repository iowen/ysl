                ...
                case 'modal':
                    template = '<div class="bootstrap-timepicker modal hide fade in" style="top: 30%; margin-top: 0; width: 200px; margin-left: -100px;" data-backdrop="false">'+
                                   '<div class="modal-header">'+
                                       '<a href="javascript:void(0)" class="close" data-action="hide">×</a>'+
                                       '<h3>Pick a Time</h3>'+
                                   '</div>'+
                                   '<div class="modal-content">'+
                                       '<table>'+
                                           '<tr>'+
                                               ...
                                               ( this.showMeridian ? '<td><a href="javascript:void(0)" data-action="toggleMeridian"><i class="icon-chevron-up"></i></a></td>' : '' ) +
                                           '</tr>'+
                                           '<tr>'+
                                           ...
                                           '<tr>'+
                                               ...
                                               ( this.showMeridian ? '<td><a href="javascript:void(0)" data-action="toggleMeridian"><i class="icon-chevron-down"></i></a></td>' : '' ) +
                                           '</tr>'+
                                       '</table>'+
                                   '</div>'+
                                   '<div class="modal-footer">'+
                                       '<a href="javascript:void(0)" class="btn btn-primary" data-action="hide">Ok</a>'+
                                   '</div>'+
                               '</div>';
